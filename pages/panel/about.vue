<template>
  <el-card class="box-card">
    ...
    <div class="text item">
      <el-image style="margin: 15px; height: 90%; width: 90%; max-width: 150px; max-height: 150px" fit="fill"
        src="/qwingin-icon.svg" /><br>
      <el-text>「青镜」玩家管理面板，旨在为多外置提供可视化用户自管理解决方案。</el-text><br>
      <el-text>Made by
        <el-link target="_blank" href="https://github.com/SPCraftMC">
          <b>SPCraftMC</b>
        </el-link>
        &
        <b>
